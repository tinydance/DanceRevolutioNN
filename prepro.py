...
parser.add_argument('--input_audio_dir', type=str, default='/mnt/data/dance-data/youtube/audio_1min')
parser.add_argument('--input_dance_dir', type=str, default='/mnt/data/dance-data/youtube/json_1min')
