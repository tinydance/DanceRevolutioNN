...
parser.add_argument('--train_dir', type=str, default='data/train_1min_hiphop')
parser.add_argument('--valid_dir', type=str, default='data/valid_1min_hiphop')
