...
Please download the dataset of dance videos from [here](https://drive.google.com/file/d/16LTR3R16Mkb_hK81r0JsSscUGLyRFG3o/view?usp=sharing) and install [OpenPose](https://github.com/CMU-Perceptual-Computing-Lab/openpose) for 2D human pose extraction.
